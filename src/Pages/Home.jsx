...
const WORDS = ["Blockchain Developer", "Tech Enthusiast", "Startup Enthusiast", "BITS, Pilani" , "Web3 Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "Typescript", "Next.js", "express js", "MongoDB"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/sanchit-4" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/sanchit-goyal-6570a1282/",
  },
  { icon: Twitter, link: "https://x.com/Sanchitgoyal283" },
  { icon: Email, link: "mailto:sanchitgoyal2803@gmail.com"}
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  ...
                  for Digital Solutions. Let's work together!
